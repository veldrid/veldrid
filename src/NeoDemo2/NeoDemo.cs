...
namespace Veldrid.NeoDemo
{
    public class NeoDemo
    {
        ...
        public static PixelFormat SwapchainFormat { get; private set; }
        public static uint SwapchainBufferCount { get; private set; }
        ...
        public NeoDemo()
        {
            ...
            _igRenderable = new ImGuiRenderable(_window.Width, _window.Height, _swapchain.BufferCount);
        ...
        private void Draw()
        {
            ...
            if (_windowResized)
            {
                ...
                _sc.RecreateWindowSizedResources(_gd, _swapchain);
            }
            ...
            _frameLoop.RunFrame((CommandBuffer cb, uint frameIndex, Framebuffer fb) =>
            {
                FrameIndex = frameIndex;
                CommonMaterials.FlushAll(cb);
                _scene.RenderAllStages(_gd, cb, _sc, fb);
            });
        }
        ...
        {
            _sc.CreateDeviceObjects(_gd, _sc, _swapchain);
            CommonMaterials.CreateAllDeviceObjects(_gd);
            _scene.CreateAllDeviceObjects(_gd, _sc);
        }
    }
}
