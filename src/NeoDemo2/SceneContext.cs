...
namespace Veldrid.NeoDemo
{
    public class SceneContext
    {
        ...
        public void CreateDeviceObjects(GraphicsDevice gd, SceneContext sc, Swapchain swapchain)
        {
            ...
            PointLightsBuffer.Update(0, pli.GetBlittable());
            ...
            RecreateWindowSizedResources(gd, swapchain);
        ...
        public unsafe void UpdateCameraBuffers(CommandBuffer cb)
        {
            cb.UpdateBuffer(ProjectionMatrixBuffer, 0, Camera.ProjectionMatrix);
            cb.UpdateBuffer(ViewMatrixBuffer, 0, Camera.ViewMatrix);
            cb.UpdateBuffer(CameraInfoBuffer, 0, Camera.GetCameraInfo());
        }

        internal void RecreateWindowSizedResources(GraphicsDevice gd, Swapchain swapchain)
        {
            MainSceneColorTexture?.Dispose();
            MainSceneDepthTexture?.Dispose();
            MainSceneResolvedColorTexture?.Dispose();
