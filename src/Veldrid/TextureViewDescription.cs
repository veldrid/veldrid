...
namespace Veldrid
{
    ...
    public struct TextureViewDescription : IEquatable<TextureViewDescription>
    {
        ...
        {
            Target = target;
            ViewType = GetFromTexture(target);
            BaseMipLevel = 0;
        ...
        public TextureViewDescription(Texture target, TextureViewType viewType)
        {
            Target = target;
        ...
        /// the same PixelFormat or its sRGB/non-sRGB counterpart.</param>
        /// <param name="viewType">The view type to create or <see cref="TextureViewType.Undefined"/> to detect from texture.</param>
        public TextureViewDescription(Texture target, PixelFormat format, TextureViewType viewType)
        {
            Target = target;
            ViewType = GetFromTexture(viewType, target, target.Usage);
            BaseMipLevel = 0;
        ...
        /// <param name="arrayLayers">The number of array layers visible in the view.</param>
        /// <param name="viewType">The view type to create or <see cref="TextureViewType.Undefined"/> to detect from texture.</param>
        public TextureViewDescription(Texture target, uint baseMipLevel, uint mipLevels, uint baseArrayLayer, uint arrayLayers, TextureViewType viewType)
        {
            Target = target;
            ViewType = GetFromTexture(viewType, target, target.Usage);
            BaseMipLevel = baseMipLevel;
        ...
        /// <param name="arrayLayers">The number of array layers visible in the view.</param>
        /// <param name="viewType">The view type to create or <see cref="TextureViewType.Undefined"/> to detect from texture.</param>
        public TextureViewDescription(Texture target, PixelFormat format, uint baseMipLevel, uint mipLevels, uint baseArrayLayer, uint arrayLayers, TextureViewType viewType)
        {
            Target = target;
            ViewType = GetFromTexture(viewType, target, target.Usage);
            BaseMipLevel = baseMipLevel;
